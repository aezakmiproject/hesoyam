...
export const menuItemClass
  = 'relative flex h-8 w-full cursor-default select-none items-center gap-2 rounded-[6px] px-2 text-[13px] leading-none text-[var(--ds-gray-1000)] outline-none data-highlighted:bg-[var(--ds-gray-100)] focus:bg-[var(--ds-gray-100)] data-disabled:pointer-events-none data-disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=size-])]:size-4 data-[type=error]:text-[var(--ds-red-700)] data-[type=error]:data-highlighted:bg-[var(--ds-red-700)]/10 data-[type=error]:focus:bg-[var(--ds-red-700)]/10'
